...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 2668088);
	iki_vhdl_file_variable_register(dp + 2668144);
	iki_vhdl_file_variable_register(dp + 2673040);
	iki_vhdl_file_variable_register(dp + 2673112);
