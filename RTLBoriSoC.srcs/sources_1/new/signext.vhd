...
entity signext is
    ...
    port (
        imm : in std_logic_vector(w-1 downto 0); -- 20-bit immediate input
        imm_extended : out std_logic_vector(31 downto 0) -- 32-bit signed extended output
    );
end entity;
...
begin
    ...
    begin
        ext := (others => imm(w-1)); -- sign extend the immediate
